...
> DOI (pendiente o Zenodo) · Código bajo MIT · Documentación y figuras bajo CC BY 4.0.
...
**Código fuente**
MIT License — © 2025 Jesús Castro · JESUSCASTRODATA
[https://opensource.org/licenses/MIT](https://opensource.org/licenses/MIT)

**Documentos y figuras**
...
> Los **datos originales** (INE, Ministerio del Interior, Eurostat) conservan sus propias condiciones de reutilización.
> Ver `docs/DATOS_Y_LICENCIAS.md` para detalles.
...
MIT (código) · CC BY 4.0 (documentación/figuras) · Datos: según fuente original.
